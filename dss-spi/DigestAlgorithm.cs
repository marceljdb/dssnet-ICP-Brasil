...
namespace EU.Europa.EC.Markt.Dss
{
    ...
    public sealed class DigestAlgorithm
    {
        ...
        public static readonly EU.Europa.EC.Markt.Dss.DigestAlgorithm SHA256withRSA = new EU.Europa.EC.Markt.Dss.DigestAlgorithm
         ("SHA256withRSA", "2.16.840.1.101.3.4.2.1", /*DigestMethod.SHA512*/"SHA256withRSA");
        ...
        public static EU.Europa.EC.Markt.Dss.DigestAlgorithm GetByName(string algoName)
        {
            ...
            if ("SHA256withRSA".Equals(algoName))
            {
